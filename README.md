...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-22 15:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a16f1013-2b93-48df-8083-3e48a7b812ac.git
$ cd a16f1013-2b93-48df-8083-3e48a7b812ac
```
